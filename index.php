			...
			<div class="center">
				...
				<!--	<div class="data">
					...
					<div class="data">
							...
							<input type="text" name="bachelor" size="30" maxlength="250" value=""/><br>
							<p>Enter the Degree name in which you are studying</p><br>

							<label>College Name*</label>
							<input type="text" name="bachelor_college" size="30" maxlength="250" value=""/><br>
							<p>Enter the university to which your college is affiliated</p>	<br>

							<label>Year of Completion</label>
							<input type="number" name="bachelor_completion" size="30" maxlength="4" value=""/><br>
							<p>Expected Year of Completion</p><hr>
				...
				<h3>Personal Details</h3>
					...
					<label>Gaurdian's Name</label>
						<input type="text" name="gaurdian" size="30" maxlength="50" value=""/><br>
						<p>Enter Your Gaurdian's Name</p><br>
					</div>
					<label>Gender</label>
					<div class="gender">
						...
						<input type="radio" name="gender" value="Female"/>
						<label>Don't wanna disclose</label><br><br>
					</div>
					<div class="data">
